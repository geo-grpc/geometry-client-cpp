...
namespace {
    ...
    TEST_F(GeometryClientTest, TEST_CUT_1){
        ...
        geometry::GeometryBagData serviceGeometry;
        ...
        geometry::GeometryBagData cutterGeometry;
        const char* wkt_cutter = "LINESTRING(0 0, 45 45)";
        cutterGeometry.add_geometry_strings(wkt_cutter);
        cutterGeometry.set_geometry_encoding_type(geometry::GeometryEncodingType::wkt);
        ...
        operatorRequest->set_operator_type(geometry::ServiceOperatorType::Cut);
